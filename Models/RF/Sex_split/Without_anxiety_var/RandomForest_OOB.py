...
results = pyreadr.read_r("/rds/general/project/hda_24-25/live/TDS/Group03/Datasets/Variables_blocks/list_anxiety_var.rds")
list_anxiety_var = list(results.values())[0].squeeze()

X_train = X_train.drop(columns=list(set(list_anxiety_var) & set(X_train.columns)))
X_test = X_test.drop(columns=list(set(list_anxiety_var) & set(X_test.columns)))
...
with open(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/best_params_OOB_{sex}.json", "w") as f:
...
metrics_df.to_csv(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/classification_metrics_{sex}.csv", index=False)
...
np.savetxt(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/roc_curve_RF_{sex}.txt",
           np.column_stack((fpr, tpr)), delimiter=",", header="FPR,TPR", comments="")

# Save AUC separately
with open(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/auc_RF_{sex}.txt", "w") as f:
    f.write(f"AUC: {auc}\n")
...
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/confusion_matrix_{sex}.png", dpi=300, bbox_inches="tight")
...
with open(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/importances_var_{sex}.json", "w") as f:
...
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/variable_importance_plot_{sex}.png", dpi=300, bbox_inches="tight")
...
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/shap_bar_plot_{sex}.png", dpi=300, bbox_inches="tight")
...
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/RF/Without_anxiety_var/shap_density_plot_{sex}.png", dpi=300, bbox_inches="tight")
...
fig.tight_layout()
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/RFWithout_anxiety_var//permutation_importance_plot_{sex}.png", dpi=300, bbox_inches="tight")
