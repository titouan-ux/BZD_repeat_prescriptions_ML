...
results = pyreadr.read_r("/rds/general/project/hda_24-25/live/TDS/Group03/Datasets/X_train_fem_bio.rds")
...
results = pyreadr.read_r("/rds/general/project/hda_24-25/live/TDS/Group03/Datasets/X_test_fem_bio.rds")
