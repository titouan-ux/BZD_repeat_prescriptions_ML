...
results = pyreadr.read_r("/rds/general/project/hda_24-25/live/TDS/Group03/Datasets/X_train_male_bio.rds")
...
results = pyreadr.read_r("/rds/general/project/hda_24-25/live/TDS/Group03/Datasets/X_test_male_bio.rds")
X_test = list(results.values())[0]

sex="male"
save_path ="/rds/general/project/hda_24-25/live/TDS/Group03/RF/biomarkers"
