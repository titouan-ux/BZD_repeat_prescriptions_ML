...
metrics_df.to_csv(f"/rds/general/project/hda_24-25/live/TDS/Group03/XGboost/Randomised_search/classification_metrics_{sex}.csv", index=False)
...
plt.title("ROC Curve")
plt.legend()
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/XGboost/Randomised_search/roc_curve_{sex}.png", dpi=300, bbox_inches="tight")

# Save FPR and TPR as a CSV file
np.savetxt(f"/rds/general/project/hda_24-25/live/TDS/Group03/XGboost/Randomised_search/roc_curve_XGboost_{sex}.txt",
           np.column_stack((fpr, tpr)), delimiter=",", header="FPR,TPR", comments="")

# Save AUC separately
with open(f"/rds/general/project/hda_24-25/live/TDS/Group03/XGboost/Randomised_search/auc_XGboost_{sex}.txt", "w") as f:
    f.write(f"AUC: {auc}\n")
...
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/XGboost/Randomised_search/confusion_matrix_{sex}.png", dpi=300, bbox_inches="tight")


#Importance Plot
xgb.plot_importance(bst, importance_type='gain', max_num_features=30)  # Top 30 features
plt.savefig(f"/rds/general/project/hda_24-25/live/TDS/Group03/XGboost/Randomised_search/variable_importance_{sex}.png", dpi=300, bbox_inches="tight")
plt.close()  # Close the figure

feature_importance = bst.get_score(importance_type="gain")  # "weight" counts how many times a feature is used

with open(f"/rds/general/project/hda_24-25/live/TDS/Group03/XGboost/Randomised_search/variable_importance_{sex}.json", "w") as f:
